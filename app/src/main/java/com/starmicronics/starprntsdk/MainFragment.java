...
public class MainFragment extends ItemListFragment implements CommonAlertDialogFragment.Callback {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch (position) {
            ...
            case 12: {   // Tapped Melody Speaker row
            ...
            case 14: {   // Tapped Combination row
            ...
            case 18: {   // Tapped AllReceipts row
            ...
            case 20: {   // Tapped Device Status row (Device Status/Firmware Information)
            ...
            case 24: {   // Tapped USB Serial Number row
            ...
            case 26: {   // Tapped Library Version row
